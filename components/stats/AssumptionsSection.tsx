...
export default function AssumptionsSection() {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-12">
      <section>
        <h2 className="text-2xl text-white font-black flex items-center gap-3 mb-6"><BarChart3 className="text-cyan-600"/> Uji Heteroskedastisitas (Glejser)</h2>
        <div className="bg-white p-6 rounded-3xl border border-gray-100 flex justify-between items-center">
          <div><p className="text-xs text-white uppercase font-bold">Sig. Glejser X1</p><input value={glejser} onChange={(e)=>setGlejser(e.target.value)} className="text-2xl font-black outline-none w-24"/></div>
      ...
      <section>
        <h2 className="text-2xl text-white font-black flex items-center gap-3 mb-6"><BrainCircuit className="text-red-600"/> Uji Multikolinearitas</h2>
        <div className="bg-white p-6 rounded-3xl border border-gray-100 flex justify-between items-center">
